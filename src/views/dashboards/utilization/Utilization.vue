...
import { mdiChartTimelineVariant, mdiCheck, mdiCurrencyUsd, mdiSeal, mdiTrendingUp } from '@mdi/js'
...
import Charts from './chartjs/Chartjs.vue'
import Opinion from './simple-table/Opinion.vue'

...
export default {
  ...
  try {
    ...
    if (loginResponse && loginResponse.data) {
      ...
      const userResponse = await axios.get('https://teleiosapi.panoramicspace.com/api/profile', {
        headers: {
      ...
      if (userResponse && userResponse.data && userResponse.data.user) {
        ...
        if (userAbility) {
          ...
          // Remove 'ability' property from the user object
          delete user.ability;

          // Set user's data in localStorage for UI/Other purposes
